    ...
    var edge = {/*
        ...
        draw : function() {
            ...
            var x1 = p[res[0]].x,
                ...
                x4 = p[res[1]].x,
                y4 = p[res[1]].y,
                dx = Math.max(Math.abs(x1 - x4) / 2, 5),
                dy = Math.max(Math.abs(y1 - y4) / 2, 5),
            ...
            if(style && style.directed) {
                ...
                var norm = function(x,l){return (-x*(l||4)/mag);};
            ...
            edge.bg && edge.bg[move]({path:path})
                || style && style.fill && (edge.bg = style.fill.split && selfRef.path(path).attr({stroke: style.fill.split("|")[0], fill: "none", "stroke-width": style.fill.split("|")[1] || 3, "stroke-dasharray":style.dash || ''}).toBack());
            /* setting label */
            style && style.label 
